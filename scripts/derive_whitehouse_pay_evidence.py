...
def main(argv: list[str] | None = None) -> int:
    ...
    store = {
        "_note": (
            ...
            "title is paid this figure as of that date - never that the post pays it to whoever holds it. Titles "
            "carried by more than one person are refused, because two salaries under one title make the figure "
            "undecidable. Rows reading $0.00 are refused: ten of them are uncompensated appointees, and an "
