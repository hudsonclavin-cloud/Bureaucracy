...
class SourceDiscoveryTests(unittest.TestCase):
    def test_discover_candidates_builds_review_queue_records(self) -> None:
        previous_template_flag = os.environ.get("PIPELINE_ENABLE_TEMPLATE_LEADERSHIP")
        os.environ["PIPELINE_ENABLE_TEMPLATE_LEADERSHIP"] = "1"
        try:
            ...
            if previous_template_flag is None:
                os.environ.pop("PIPELINE_ENABLE_TEMPLATE_LEADERSHIP", None)
            else:
                os.environ["PIPELINE_ENABLE_TEMPLATE_LEADERSHIP"] = previous_template_flag
